...
class EnfInventarioAdminController extends Controller
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                $fechaingreso = $object->getFechaIngresoInventario()->format('Y-m-d H:i:s');
                
                $id = $object->getId();
               // $diag = $object->getIdCtlDiag()->getId();
               // $empcor = $object->getIdEmpCorr()->getId();
               // $exp = $object->getIdExpediente()->getId();
                $sql_query = "select count(date_trunc('minute', fecha_ingreso_inventario)) as total from enf_inventario where 
 date_trunc('minute', fecha_ingreso_inventario) = date_trunc('minute', TIMESTAMP '$fechaingreso')";
...
//                tema1 = $session->get('clap');
                ...
                if ($existe['total'] > 1) {
                    ...
                    $sql_query2 = "delete from enf_inventario where 
                    date_trunc('minute', fecha_ingreso_inventario) = date_trunc('minute', TIMESTAMP '$fechaingreso') and id=$id ";
                    $consulta2 = $conn->query($sql_query2);
                    return $this->redirect($this->generateUrl('admin_minsal_sipernes_enfinventario_create'));
                } else {
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
