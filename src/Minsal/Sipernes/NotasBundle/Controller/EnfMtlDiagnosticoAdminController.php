...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                $sql_query = "select count(date_trunc('minute', fecha_ingreso_diag)) as total from enf_mtl_diagnostico where id_ctl_diag=$diag and id_emp_corr=$empcor and id_expediente=$exp and
 date_trunc('minute', fecha_ingreso_diag) = date_trunc('minute', TIMESTAMP '$fechaingreso')";
