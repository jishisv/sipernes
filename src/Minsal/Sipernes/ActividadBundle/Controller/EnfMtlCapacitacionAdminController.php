...
//                tema1 = $session->get('clap');
                ...
                if ($existe['total'] > 1) {
                    ...
                    $sql_querybitacora = "delete from enf_bitacora_capacitacion where fecha_ingreso_hist_capa = '$fechaingreso'";
                    $consultabit = $conn->query($sql_querybitacora);
                    $sql_querytraza = "delete from enf_traza_capacitacion where fecha_ingreso_tra_capa = '$fechaingreso'";
                    $consultatraza = $conn->query($sql_querytraza);
                    $sql_query2 = "delete from enf_mtl_capacitacion where tema_capacitacion='$tema' and id_emp_corr=$empcor and
                date_trunc('minute', fecha_ingreso_cap) = date_trunc('minute', TIMESTAMP '$fechaingreso') and id=$id; ";
