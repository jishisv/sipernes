...
class EnfMtlActividadAdmin extends Admin
{
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            //->add('id')
            ->add('idEmpCorr','text', array('label' => 'Numero de empleado'))
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            //->add('id')
            ->add('fechaModificacionAct', 'date', array('label' => 'Fecha de Actividad Realizada','required' => false))
    ...
    protected function configureShowFields(ShowMapper $showMapper)
    {
        $showMapper
            ...
            ->add('usuarioIngresoAct','text', array('label' => 'Creado por'))
            ->add('fechaIngresoAct','date', array('label' => 'Fecha de creacion'))
            ->add('fechaModificacionAct','date', array('label' => 'Fecha de modificacion'))
