...
/**
 * EnfHistoricoCapacitacion
 *
 * @ORM\Table(name="enf_historico_capacitacion", indexes={@ORM\Index(name="IDX_6F0822CF79827853", columns={"id_capacitacion"})})
 * @ORM\Entity
 */
class EnfHistoricoCapacitacion
{
    /**
     * @var integer
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="enf_historico_capacitacion_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
     ...
     * @return EnfHistoricoCapacitacion
     */
