...
class CtlDepartamento
{
     ...
     *
     * @param \Minsal\SipernesBundle\Entity\CtlEstablecimiento $idEstablecimientoRegion
     * @return CtlDepartamento
     */
    public function setIdEstablecimientoRegion(\Minsal\SipernesBundle\Entity\CtlEstablecimiento $idEstablecimientoRegion = null)
    {
     ...
     * Set idPais
     *
     * @param \Minsal\SipernesBundle\Entity\CtlPais $idPais
     * @return CtlDepartamento
     */
    public function setIdPais(\Minsal\SipernesBundle\Entity\CtlPais $idPais = null)
    {
        $this->idPais = $idPais;
