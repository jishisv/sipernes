 ...
 * CtlEstablecimiento
 *
 * @ORM\Table(name="ctl_establecimiento", indexes={@ORM\Index(name="IDX_332BD42C3544B551", columns={"id_establecimiento_padre"}), @ORM\Index(name="IDX_332BD42C7EAD49C7", columns={"id_municipio"})})
 * @ORM\Entity
 */
class CtlEstablecimiento
{
     ...
     *
     * @param \Minsal\SipernesBundle\Entity\CtlEstablecimiento $idEstablecimientoPadre
     * @return CtlEstablecimiento
     */
    public function setIdEstablecimientoPadre(\Minsal\SipernesBundle\Entity\CtlEstablecimiento $idEstablecimientoPadre = null)
    {
     ...
     * Set idMunicipio
     *
     * @param \Minsal\SipernesBundle\Entity\CtlMunicipio $idMunicipio
     * @return CtlEstablecimiento
     */
    public function setIdMunicipio(\Minsal\SipernesBundle\Entity\CtlMunicipio $idMunicipio = null)
    {
