...
/**
 * EnfHistoricoIntervencion
 *
 * @ORM\Table(name="enf_historico_intervencion", indexes={@ORM\Index(name="IDX_299D5463675DADD6", columns={"id_registro_intervencion"})})
 * @ORM\Entity
 */
class EnfHistoricoIntervencion
{
    /**
     * @var integer
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="enf_historico_intervencion_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
     ...
     * @return EnfHistoricoIntervencion
     */
