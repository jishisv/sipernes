 ...
 * SecHistorialClinico
 *
 * @ORM\Table(name="sec_historial_clinico", indexes={@ORM\Index(name="fki_fos_user_user_sec_historial_clinico", columns={"idusuarioreg"}), @ORM\Index(name="fki_mnt_aten_area_mod_estab_sec_historial_clinico", columns={"idsubservicio"}), @ORM\Index(name="IDX_B5886216890253C7", columns={"id_empleado"}), @ORM\Index(name="IDX_B5886216445651A7", columns={"id_numero_expediente"}), @ORM\Index(name="IDX_B588621675BB31F7", columns={"idestablecimiento"})})
 * @ORM\Entity
 */
class SecHistorialClinico
{
     ...
     * @var integer
     *
     * @ORM\Column(name="idsubservicio", type="integer", nullable=true)
     */
     ...
     *
     * @param \Minsal\SipernesBundle\Entity\MntExpediente $idNumeroExpediente
     * @return SecHistorialClinico
     */
    public function setIdNumeroExpediente(\Minsal\SipernesBundle\Entity\MntExpediente $idNumeroExpediente = null)
    {
     ...
     * Set idusuarioreg
     *
     * @param \Minsal\SipernesBundle\Entity\FosUserUser $idusuarioreg
     * @return SecHistorialClinico
     */
    public function setIdusuarioreg(\Minsal\SipernesBundle\Entity\FosUserUser $idusuarioreg = null)
    {
