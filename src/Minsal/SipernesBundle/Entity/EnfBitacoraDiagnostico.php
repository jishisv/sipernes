...
/**
 * EnfBitacoraDiagnostico
 *
 * @ORM\Table(name="enf_bitacora_diagnostico", indexes={@ORM\Index(name="IDX_BCA01F46A48933A", columns={"id_registro_diag"})})
 * @ORM\Entity
 */
class EnfBitacoraDiagnostico
{
    /**
     * @var integer
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="enf_bitacora_diagnostico_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
