 ...
 * EnfHistoricoDosis
 *
 * @ORM\Table(name="enf_historico_dosis", indexes={@ORM\Index(name="IDX_57A529CFDC13B9AD", columns={"id_dosis_esq"})})
 * @ORM\Entity
 */
class EnfHistoricoDosis
{
    /**
     * @var integer
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="enf_historico_dosis_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
