...
class FosUserGroup
{
     ...
     * Add user
     *
     * @param \Minsal\SipernesBundle\Entity\FosUserUser $user
     * @return FosUserGroup
     */
    public function addUser(\Minsal\SipernesBundle\Entity\FosUserUser $user)
    {
        $this->user[] = $user;
     ...
     * @param \Minsal\SipernesBundle\Entity\FosUserUser $user
     */
    public function removeUser(\Minsal\SipernesBundle\Entity\FosUserUser $user)
    {
