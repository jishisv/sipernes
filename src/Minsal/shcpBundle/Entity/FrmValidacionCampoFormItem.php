...
class FrmValidacionCampoFormItem
{
     ...
     *
     * @param \Minsal\shcpBundle\Entity\CtlValidacionCampo $idValidacionCampo
     * @return FrmValidacionCampoFormItem
     */
    public function setIdValidacionCampo(\Minsal\shcpBundle\Entity\CtlValidacionCampo $idValidacionCampo = null)
    {
