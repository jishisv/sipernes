...
class FosUserUser
{
     ...
     * Add group
     *
     * @param \Minsal\shcpBundle\Entity\FosUserGroup $group
     * @return FosUserUser
     */
    public function addGroup(\Minsal\shcpBundle\Entity\FosUserGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \Minsal\shcpBundle\Entity\FosUserGroup $group
     */
    public function removeGroup(\Minsal\shcpBundle\Entity\FosUserGroup $group)
    {
