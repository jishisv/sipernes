...
class FrmInsercionDependencia
{
     ...
     *
     * @param \Minsal\shcpBundle\Entity\FrmGrupoInsercion $idGrupoInsercionDependiente
     * @return FrmInsercionDependencia
     */
    public function setIdGrupoInsercionDependiente(\Minsal\shcpBundle\Entity\FrmGrupoInsercion $idGrupoInsercionDependiente = null)
    {
     ...
     *
     * @param \Minsal\shcpBundle\Entity\FrmGrupoInsercion $idGrupoInsercionPadre
     * @return FrmInsercionDependencia
     */
    public function setIdGrupoInsercionPadre(\Minsal\shcpBundle\Entity\FrmGrupoInsercion $idGrupoInsercionPadre = null)
    {
