...
class FosUserGroup
{
     ...
     * Add user
     *
     * @param \Minsal\shcpBundle\Entity\FosUserUser $user
     * @return FosUserGroup
     */
    public function addUser(\Minsal\shcpBundle\Entity\FosUserUser $user)
    {
        $this->user[] = $user;
     ...
     * @param \Minsal\shcpBundle\Entity\FosUserUser $user
     */
    public function removeUser(\Minsal\shcpBundle\Entity\FosUserUser $user)
    {
