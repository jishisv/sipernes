...
class CtlEstablecimiento
{
    ...
    /* code ... */
     ...
     /**
     *
     * @ORM\OneToMany(targetEntity="ShcpAboAdmisionProceden", mappedBy="$idEstablecimiento", cascade={"all"}, orphanRemoval=true)
     *
     */
    private $aboAdmision;
    ...
    {
        $this->aboAdmision = new \Doctrine\Common\Collections\ArrayCollection();
    }
