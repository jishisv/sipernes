...
class MenuBuilder extends ContainerAware {
    ...
    private $cat = array('AD' => array('label' => 'Administración', 'icon' => 'glyphicon glyphicon-cog'),
        ...
        'RPT' => array('label' => 'Reportes 1', 'icon' => 'glyphicon glyphicon-file'),
       ...
       // 'APL' => array('label' => 'Aplicacion', 'icon' => 'glyphicon glyphicon-circle'),
        ...
        'INS' => array('label' => 'Inscripción', 'icon' => 'glyphicon glyphicon-pencil'),
        'CON' => array('label' => 'Control de Seguimiento', 'icon' => 'glyphicon glyphicon-check'),
        'PAR' => array('label' => 'Parto', 'icon' => 'glyphicon glyphicon-ok-circle'),
        'ABT' => array('label' => 'Aborto', 'icon' => 'glyphicon glyphicon-bell'),
        'PRE' => array('label' => 'Preparación', 'icon' => 'glyphicon glyphicon-edit'),
        'CTL' => array('label' => 'Mantenimiento de Catálogos', 'icon' => 'glyphicon glyphicon-book'));
            ...
            switch ($level) {
                ...
                case '2':
                    ...
                    foreach ($contMenu as $keyb => $itemb) {
                        $this->menu[$catLabel]->addChild($itemb['label'], array('uri' => $itemb['url']));
                    }
                        }
                    break;
